<div class="col-12 col-md-4">
    <a href="{{ route('event.index') }}/{{ $event->eventDetail->slug }}">
        <div class="card">
            <img src="{{ Storage::exists($event->eventBanner->file_path) ? Storage::url($event->eventBanner->file_path) : $event->EventBanner->file_path }}" class="card-img-top img-fluid" style="max-height: 15rem" alt="Event Banner">
