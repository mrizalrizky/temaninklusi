<div class="row align-items-center justify-content-center gap-4 mb-3">
    ...
    <div class="col-md-5">
        <p class="text-primary mb-1"><small style="font-size: .8rem">{{ $article->articleCategory->label ?? ''}}</small></p>
        <h5 class="fw-bold">{{ $article->title }}</h5>
        <p style="font-size: .9rem" class="elipsis-description">{{ Str::limit($article->content, 128) }}</p>
