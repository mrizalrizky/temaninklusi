...
@section('content')
    <div class="container-lg px-4 px-lg-3">
        <div class="d-flex justify-content-end gap-2 my-4">
            @if (Auth::check())
                @can('is-admin')
                    ...
                    <button type="submit" class="badge btn btn-secondary d-flex gap-2 align-items-center"
        ...
        <section class="d-flex flex-column flex-md-row justify-content-between p-1 gap-5 mb-5">
            <div class="col">
                ...
                <ul class="nav d-flex gap-3 mb-4 justify-content-center justify-content-md-start flex-nowrap" id="pills-tab"
                    role="tablist">
                    <x-button.pill-button class="active" id="description-tab" dataBsTarget="#pills-description"
