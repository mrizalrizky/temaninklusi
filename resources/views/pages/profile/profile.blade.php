                        ...
                        <form action="{{ route('profile.validate') }}" class="w-100" method="POST">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input type="text" class="form-control py-2 @error('name') is-invalid @enderror"
                                    ...
                                    value="{{ old('name') ?? $user->name }}" placeholder="Jane Doe">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input type="text" class="form-control py-2 @error('username') is-invalid @enderror"
                                    ...
                                    value="{{ old('username') ?? $user->username }}" placeholder="Jane Doe">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input type="text" class="form-control py-2 @error('phone_number') is-invalid @enderror"
                                    ...
                                    value="{{ old('phone_number') ?? $user->phone_number }}" placeholder="{{ $user->phone_number }}" disabled>
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input type="text" class="form-control py-2 @error('organizer_name') is-invalid @enderror"
                                    ...
                                    value="{{ old('organizer_name') ?? $user->organizer->name }}" placeholder="{{ $user->organizer->name }}" disabled>
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input type="text" class="form-control py-2 @error('organizer_contact_name') is-invalid @enderror"
                                    ...
                                    value="{{ old('organizer_contact_name') ?? $user->organizer->contact_name }}" placeholder="{{ $user->organizer->contact_name }}" disabled>
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input type="text" class="form-control py-2 @error('organizer_address') is-invalid @enderror"
                                    ...
                                    value="{{ old('organizer_address') ?? $user->organizer->address }}" placeholder="{{ $user->organizer->address }}" disabled>
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input type="text" class="form-control py-2 @error('organizer_contact_email') is-invalid @enderror"
                                    ...
                                    value="{{ old('organizer_contact_email') ?? $user->organizer->contact_email }}" placeholder="{{ $user->organizer->contact_email }}" disabled>
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input type="text" class="form-control py-2 @error('organizer_contact_phone') is-invalid @enderror"
                                    ...
                                    value="{{ old('organizer_contact_phone') ?? $user->organizer->contact_phone }}" placeholder="{{ $user->organizer->contact_phone }}" disabled>
