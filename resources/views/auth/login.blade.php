            ...
            <div class="row g-7 justify-content-center justify-content-md-between">
                <div class="col-12 col-sm-10 col-md-7">
                    <form enctype="multipart/form-data" action="{{ route('login') }}" method="POST"
                        ...
                        <x-form.base-form-input class="mb-4 @error('email') is-invalid @enderror" type="email" value="{{ old('email') }}" name="email" :label="true">
                            @error('email')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <x-form.base-form-input class="mb-2 @error('password') is-invalid @enderror" type="password" value="{{ old('email') }}" name="password" :label="true" placeholder="●●●●●●●●">
                            @error('password')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
